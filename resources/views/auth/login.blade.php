                        ...
                        <div class="card-block">
                            ...
                            <form class='validate-form' role="form" method="POST" action="{{ url('sign-in') }}">
                                ...
                                <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        <input name="email" type="text" value="admin@gmail.com" class="form-control" placeholder="@lang('common.label.email')">
                                        @if ($errors->has('email'))
                                ...
                                <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        <input type="password" name="password" value="123456" placeholder="@lang('common.label.password')" class="form-control">
