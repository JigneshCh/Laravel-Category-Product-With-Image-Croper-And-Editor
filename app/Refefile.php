...
class Refefile extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['refe_table_field_name', 'refe_field_id', 'refe_file_path','refe_file_name','refe_file_real_name', 'refe_code','refe_type','priority','file_size'];
	
	protected $appends = ['file_url','file_thumb_url','file_path','file_thumb_path'];
	
	public function refefileDetail()
    {
        return $this->hasMany('App\RefefileDetail', 'refe_field_id', 'id')->where('refe_table_field_name', 'refe_file');
    }
